...
### PHASE 2 – Pattern Revelation (Killer Feature)
Goal: “Oh wow” moment
- Dynamic hotspot / heatmap layer (deck.gl HeatmapLayer)
- Derived from **current viewport + date range**
- Toggleable layer
- Timeline scrub → animated hotspot shift (animation optional at first)

### PHASE 3 – Dataset Expansion (Careful)
...
### PHASE 4 – UX Power Tools
Goal: Serious users feel respected
- List + map split view
- Clicking report focuses map
- Popup maximize
- Simple voting/curation 👍 / 👎 (no moderation yet)

### PHASE 5 – Researcher Gravity
Goal: Attract contributors, not tourists
- County overlay (visual only at first)
- Data export (CSV / GeoJSON)
- “API planned” mention is enough (no full API commitment required)
